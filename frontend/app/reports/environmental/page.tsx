        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              H1 2024 Environmental Impact Analysis
            </p>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" gap-2="true">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">47% renewable</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">
                  Waste Generated
                ...
                <p className="text-xs text-green-600">45% recycled</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">
                  Water Used
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-green-600">Target: 1.8 by 2025</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
                    Water Intensity
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-green-600">Target: 75% by 2030</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <p className="text-xs text-green-600">Target: 80% by 2025</p>
                </div>
              </div>
            </div>
          </CardContent>
